...
export default function AlgoDropdown( { options, algoChoice, handleAlgoSelect } : {options : Array<{algorithmName: string, algorithmStep: Function}>, algoChoice: number, handleAlgoSelect: Function } ) {
  return (
